...
namespace SchoolManagementApp.MVC.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        {
            var schoolManagementDbContext = _context.Enrollments.Include(e => e.Lesson).Include(e => e.Student);
        ...
        public async Task<IActionResult> Create([Bind("Id,StudentId,LessonId,Grade")] Enrollment enrollment)
        {
            ...
            ViewData["LessonId"] = new SelectList(_context.Lessons, "Id", "Id", enrollment.LessonId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,StudentId,LessonId,Grade")] Enrollment enrollment)
        {
            if (id != enrollment.Id)
            {
                return NotFound();
